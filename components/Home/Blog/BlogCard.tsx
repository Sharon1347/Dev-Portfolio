...
const BlogCard = ({ blog }:Props) => {
  ...
  return <div className=" bg-blue-950 rounded-md overflow-hidden">
    <Image src={image} 
    alt={title} 
    width={300} 
    height={300}
    ...
    />
    <div className="p-6">
        <p className="rounded-sm px-6 py-1.5 bg-sky-500 text-white w-fit">
            News
        </p>
        ...
        <p className="text-sm font-semibold text-opacity-70 text-gray-400">{summary}
        </p>
        ...
        <div className="flex items-center justify-between">
            ...
            <button className="text-base hover:text-sky-400 text-gray-200 underline font-bolds">Read More</button>
        </div>
