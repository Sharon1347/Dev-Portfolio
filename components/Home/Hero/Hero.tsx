...
const Hero = () => {
  return (
<div className="w-full pt-[4vh] md:pt-[12vh] h-screen bg-[#0F1A38] overflow-hidden relative">
            ...
            className="text-2xl md:text-3xl lg:text-4xl mb-5 text-gray-300 font-semibold">
                ...
                <h1 data-aos="fade right" data-aos-delay="100" className="text-bg text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[4rem] text-white">
                    ...
                    <p data-aos="fade-left" data-aos-delay="200" className="mt-6 text-sm md:text-base text-white text-opacity-60">
                        ...
                        {/* Button */}
                        <button data-aos="zoom-in" data-aos-delay="300" className="md:px-8 md:py-2.5 px-6 py-1.5 text-white  font-semibold text-sm md:text-lg transition-all duration-200 rounded-lg mt-8 bg-[#3A5A96] hover:bg-blue-900 flex items-center space-x-2">
