...
const ContactInfo = () => {
  return <div>
    <div className="flex items-center space-x-8">
      <div className="w-10 h-10 md:w-14 md:h-14 rounded-full bg-gradient-to-r from-emerald-500 to-emerald-900 flex items-center justify-center flex-col">
        <FaPhone className="w-4 md:w-7 md:h-7 text-white"/>
      </div>
      <div>
    ...
    <div className="flex items-center space-x-8 mt-8 mb-8">
      <div className="w-10 h-10 md:w-14 md:h-14 rounded-full bg-gradient-to-r from-emerald-500 to-emerald-900 flex items-center justify-center flex-col">
        <FaEnvelope className="w-4 md:w-7 md:h-7 text-white"/>
      </div>
      <div>
    ...
    <div className="flex items-center space-x-8">
      <div className="w-10 h-10 md:w-14 md:h-14 rounded-full bg-gradient-to-r from-emerald-500 to-emerald-900 flex items-center justify-center flex-col">
        <FaMap className="w-4 md:w-7 md:h-7 text-white"/>
      </div>
      <div>
